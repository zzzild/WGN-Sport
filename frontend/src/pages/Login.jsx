      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs opacity-90 max-w-sm leading-relaxed font-light">
            Temukan lapangan terbaik, atur jadwalmu, dan nikmati pengalaman
            bermain yang lebih cepat, seamless, dan modern. Semua dalam satu
            platform yang dirancang khusus untuk pemain seperti kamu.
          </p>
